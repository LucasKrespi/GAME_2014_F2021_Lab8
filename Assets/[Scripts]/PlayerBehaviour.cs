...
public class PlayerBehaviour : MonoBehaviour
{
    ...
    private void Move()
    {
        ...
        if (isGrounded)
        {
            ...
            {
                x = FlipAnimation(x);
                animatorController.SetInteger("AnimationState", (int)PlayerAnimationState.RUN);
            }
            else
            {
                animatorController.SetInteger("AnimationState", (int)PlayerAnimationState.IDLE);
            }
        ...
        {
            animatorController.SetInteger("AnimationState", (int)PlayerAnimationState.JUMP);
